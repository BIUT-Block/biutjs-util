...
exports.hashPersonalMessage = function (message) {
  const prefix = exports.toBuffer('\u0019BIUT Signed Message:\n' + message.length.toString())
 ...
 * @param {String} from the address which is creating this new address
 * @param {String} nonce the nonce of the from account
 * @return {Buffer}
 */
exports.generateContractAddress = function (from) {
  ...
  // return exports.rlphash([from, nonce]).slice(-18)
  return exports.rlphash([from]).slice(-18)
}

// exports.generateContractAddressString = function (from) {
//   let addrBuffer = exports.generateContractAddress(from)
//   let addrString = addrBuffer.toString('hex')
//   return addrString
// }

exports.generateContractAddressString = function () {
  let from = '0x' + exports.generateSecKeys().secAddress
  let addrBuffer = exports.generateContractAddress(from)
  let addrString = addrBuffer.toString('hex')
  return addrString
}
 ...
 * @return {Boolean}
 */
exports.isContractAddr = function (str) {
  if (typeof str !== 'string') {
    return false
  }
  let isFlag = false
